...
**Nine of the thirteen variants are literals; four are functions of the census** (#26, #28, #31).
...
`docs/derived-variants.md`** — the partitioner behind A6, the retired A5's promotion, the mother-tongue
...
|---|---|---|
| **Which district set must a partition cover?** | `universe` on the variant — `drawn` (all 156, nothing left uncoloured) or `census` (the 136 with statistics; AJK and GB outside the partition, drawn and named and in no unit) | Per variant; all thirteen declare `drawn` |
