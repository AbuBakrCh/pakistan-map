...
**What each of the seven rules is, what it draws, and every cost stated on its card, is in
`docs/derived-variants.md`** — the partitioner behind A1 to A4, A5's promotion, the mother-tongue
