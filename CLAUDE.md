...
is one place or two. The standing words are **the tooltip's own**, read off `describeKind` rather
than retyped, so a reader who hovers a district and then reads the list is never given two different
words for one constitutional fact. Not a live region: it describes what is on screen, and announcing
